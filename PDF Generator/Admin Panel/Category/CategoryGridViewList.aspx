                    ...
                    <div class="col-md-12 col-xl-4">
                        <div class="card user-card">
                            <div class="card-header-img">
                                <asp:ImageButton runat="server" ID="imgbtnCategoryPhoto" AlternateText="Category Image" CssClass="img-fluid img-radius responsive" ImageUrl='<%# Eval("CategoryPhotoPath") %>' PostBackUrl='<%# "~/PDF Generator/Admin Panel/Item/ItemGridViewList.aspx?CategoryID=" + Eval("CategoryID").ToString().Trim() %>' />
                                <div class="card-body">
                                    <h4>
