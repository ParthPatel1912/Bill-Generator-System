                                        ...
                                        <table class="table m-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <asp:Label runat="server" ID="lblMobileNo" /> </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Password
                                                    </th>
                                                    <td> <asp:TextBox runat="server" ID="txtPassord" ReadOnly="true" BorderStyle="None" TextMode="Password"/> 
                                                    <asp:LinkButton ID="btnEyeImg" runat="server" CssClass="fa fa-eye" OnClick="btnEyeImg_Click" /> </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
