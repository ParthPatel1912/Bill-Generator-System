<%@ Page Title="State Table" Language="C#" MasterPageFile="~/PDF Generator/Content/AdminPanel.master" AutoEventWireup="true" CodeFile="StateGridViewList.aspx.cs" Inherits="PDF_Generator_Admin_Panel_State_StateGridViewList" %>
    ...
    <div class="container pb-5">
        <div>
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvState" runat="server" CssClass="table table-bordered table-hover table-striped" AutoGenerateColumns="false" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" OnRowCommand="gvState_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-BorderColor="#ff00ff" HeaderStyle-BackColor="RosyBrown" ItemStyle-CssClass="text-center" HeaderStyle-Font-Italic="true">
                            <ItemTemplate>
                                <asp:Button ID="btnedit" runat="server" Text="Edit" CssClass="button btn edit" CommandName="EditRecord" CommandArgument='<%# "~/PDF Generator/Admin Panel/State/StateAddEdit.aspx?StateID=" + Eval("StateID").ToString().Trim() %>' />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderStyle-BorderColor="#ff00ff" HeaderStyle-BackColor="RosyBrown" ItemStyle-CssClass="text-center" HeaderStyle-Font-Italic="true">
                            <ItemTemplate>
                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="button btn delete" OnClientClick="javascript:return confirm('Are you sure you want to Delete record ?');" CommandName="DeleteID" CommandArgument='<%# Eval("StateID") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
